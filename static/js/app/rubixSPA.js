...
function x_load(_url,_formname){
	...
	if (x_routes[routeKey].x_api !== undefined){
		...
		x_log(api_url,1);
		if (api_url === '/patient' || x_routes[routeKey].x_api==='/patients' || api_url === '/injuries' || x_routes[routeKey].x_api === '/injury'|| x_routes[routeKey].x_api==='/getsession'){

			
			if (x_routes[routeKey].x_api==='/patients' || x_routes[routeKey].x_api === '/injury'|| x_routes[routeKey].x_api==='/getsession'){
