...
let injuryInput = document.getElementById("selectInjury");
let errorMesssages = document.getElementById("errormesssages");
console.log("asdadasdsa"+injuryInput.value)
if (injuryInput.value === "") {
  errorMesssages.innerHTML = "Please select one injury";
  injuryInput.classList.add("error");
  validationStatus["injury"]=false;
} else {
  errorMesssages.innerHTML = "";
  injuryInput.classList.remove("error");
}
...
let genderInput = document.getElementById("level");
let errorMessaages = document.getElementById("errormessaages");
console.log(genderInput.value)
if (genderInput.value === "Gender") {
  errorMessaages.innerHTML = "Please select gender";
  genderInput.classList.add("error");
  validationStatus["gender"]=false;
} else {
  errorMessaages.innerHTML = "";
  genderInput.classList.remove("error");
}

if(validationStatus["age"]==true && validationStatus["phone"]==true && validationStatus["plannedSession"]==true && validationStatus["emailid"]==true && validationStatus["name"]==true && validationStatus["gender"]==true && validationStatus["injury"]==true ){
  x_do("web.patientA","addpatientform");
}
